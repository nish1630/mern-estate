      ...
      <form className='flex flex-col sm:flex-row gap-4'>
        <div className="flex flex-col gap-4 flex-1">
            ...
            <div className="flex flex-wrap gap-6">
                ...
                <div className="flex items-center gap-2">
                    <input type="number" id="discountedPrice" min='1' max='10' required className='p-3 border border-gray-400 rounded-lg' />
                    <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">
                ...
                <button className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow disabled:opacity-80'>Upload</button>
            </div>
            <button className='p-3 bg-slate-700 text-white rounded-lg uppercase opacity-95 disabled:backdrop-opacity-80'>Create Listing</button>
        </div>
      </form>
    </main>
  )
